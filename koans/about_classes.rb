...
class AboutClasses < EdgeCase::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    #Initialize is called by new to setup the inital state of the object. It is a common pattern
    #that you use constructor parameters to enforce class invariants so it makes sense that
    #the new would be calling initialize.
  end
