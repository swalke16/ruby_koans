...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # send is a pretty common name for a method that someone might want to use on their
    # classes. Providing an alternative with a name that is unlikely to clash ensures that
    # if someone wants to redefine send that they can still do message passing an alternate 
    # way.
  end
  ...
  def test_sending_undefined_messages_to_a_typical_object_results_in_errors
    ...
    # NOTE: there was a bug in the code here... the result of assert_raise was not being assigned to 
    # the exception var
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # We can redefine method_missing to perform some action whenever someone
    # attempts to send a message to the object that does not have an implementation
    # on that object.
  end
