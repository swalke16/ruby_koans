...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # I would think this is likely for the same reason that one would choose to use a stringbuilder in .NET. 
    # the += operator essentially is creating a new string that is the result of the operands on either side of the += 
    # which is a waste of memory and also probably less performant than just extending the original string.
  end
